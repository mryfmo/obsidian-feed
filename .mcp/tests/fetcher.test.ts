...
describe('Fetcher', () => {
  ...
  describe('Source Type Detection', () => {
    ...
    it('should detect library sources', async () => {
      ...
      mockContext7Instance.getDocumentation.mockImplementation(lib =>
        Promise.resolve({
  ...
  describe('Security Features', () => {
    it('should validate URLs before fetching', async () => {
      const maliciousUrls = ['file:///etc/passwd', 'ftp://example.com', 'unsafe:protocol'];
    ...
    it('should sanitize file paths', async () => {
      const dangerousPaths = ['../../../etc/passwd', '/etc/passwd', '~/.ssh/id_rsa'];
  ...
  describe('Multiple Source Fetching', () => {
    it('should fetch from multiple sources', async () => {
      ...
      const sources = ['https://example.com/doc1', '/path/to/file.txt', 'https://example.com/doc2'];
